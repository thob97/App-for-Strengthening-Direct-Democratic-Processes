            ...
            Column(children: <Widget>[
              Padding(padding: const EdgeInsets.only(left: 10, right: 10),
                child: Container(
                  ...
                  child: const Text('Phasenauswahl',
                    ...
                    children: [
                      ...
                      RichText(
                        text: const TextSpan(
                          ...
                          children: <TextSpan>[
                            TextSpan(text: 'Startbedingung: ', style: TextStyle(fontWeight: FontWeight.bold)),
                            TextSpan(text: 'Antrag auf amtliche \nKostenschätzung stellen'),
                            TextSpan(text: '\n\nReferenzdauer: ', style: TextStyle(fontWeight: FontWeight.bold)),
                            TextSpan(text: '8 Monate'),
                            TextSpan(text: '\n\nZu erfüllen vor Phasenabschluss:', style: TextStyle(fontWeight: FontWeight.bold, decoration: TextDecoration.underline)),
                            TextSpan(text: '\n\nAmtliche Kosteneinschätzung ', style: TextStyle(fontWeight: FontWeight.bold)),
                            TextSpan(text: '\n  •Zeit: 2 Monate (bis <<Datum>>)'),
                            TextSpan(text: '\n  •Erfüllt am: <<Datum>>'),
                            TextSpan(text: '\n\nUnterschriftensammlung ', style: TextStyle(fontWeight: FontWeight.bold)),
                            TextSpan(text: '\n  •Zeit: 6 Monate (bis <<Datum>>)'),
                            TextSpan(text: '\n\nAntrag auf Volksbegehren stellen ', style: TextStyle(fontWeight: FontWeight.bold)),
