...
DetailedProcedure _$DetailedProcedureFromJson(Map<String, dynamic> json) =>
    DetailedProcedure(
      ...
      appointments: (json['appointmentSet'] as List<dynamic>)
          ...
          .toList(),
      berlin1: json['berlin_1'] == null
          ? null
          : Berlin1.fromJson(json['berlin_1'] as Map<String, dynamic>),
      berlin2: json['berlin_2'] == null
          ? null
          : Berlin2.fromJson(json['berlin_2'] as Map<String, dynamic>),
      berlin3: json['berlin_3'] == null
          ? null
          : Berlin3.fromJson(json['berlin_3'] as Map<String, dynamic>),
    );
...
Map<String, dynamic> _$DetailedProcedureToJson(DetailedProcedure instance) =>
    <String, dynamic>{
      ...
      'berlin_1': instance.berlin1?.toJson(),
      'berlin_2': instance.berlin2?.toJson(),
      'berlin_3': instance.berlin3?.toJson(),
    };
